...
export const getProductsList = async (
  ...
  try {
    ...
    const response = await instance.get(`/admin/products/?${params.toString()}`);
...
export const getProductsByProcedure = async (
  ...
  try {
    ...
    const response = await instance.get(`/admin/products/by-procedure?${params.toString()}`);
    return response.data;
  } catch (error: unknown) {
...
export const getStandardProductDetail = async (productId: number): Promise<ProductDetailApiResponse> => {
  try {
    const response = await instance.get(`/admin/products/standard/${productId}`);
...
export const getEventProductDetail = async (productId: number): Promise<ProductDetailApiResponse> => {
  try {
    const response = await instance.get(`/admin/products/event/${productId}`);
...
export const updateEventProduct = async (productId: number, updateData: EventProductUpdateRequest): Promise<ProductResponse> => {
  try {
    const response = await instance.put(`/admin/products/event/${productId}`, updateData);
    return response.data; // 백엔드 응답 구조에 맞춰 .data 추가
  } catch (error: unknown) {
...
export const deleteStandardProduct = async (productId: number): Promise<void> => {
  try {
    await instance.delete(`/admin/products/standard/${productId}`);
  } catch (error: unknown) {
...
export const deleteEventProduct = async (productId: number): Promise<void> => {
  try {
    await instance.delete(`/admin/products/event/${productId}`);
  } catch (error: unknown) {
...
export const activateStandardProduct = async (productId: number): Promise<void> => {
  try {
    await instance.post(`/admin/products/standard/${productId}/activate`);
  } catch (error: unknown) {
...
export const activateEventProduct = async (productId: number): Promise<void> => {
  try {
    await instance.post(`/admin/products/event/${productId}/activate`);
  } catch (error: unknown) {
...
export const updateStandardProduct = async (
  ...
  try {
    const response = await instance.put(`/admin/products/standard/${productId}`, updateData);
...
export const getStandardInfoList = async (
  ...
  try {
    ...
    const response = await instance.get(`/admin/products/info/standard?${params.toString()}`);
    return response.data;
  } catch (error: unknown) {
...
export const getEventInfoList = async (
  ...
  try {
    ...
    const response = await instance.get(`/admin/products/info/event?${params.toString()}`);
    return response.data;
  } catch (error: unknown) {
...
export const getStandardInfoDetail = async (infoId: number): Promise<StandardInfoDetailResponse> => {
  try {
    const response = await instance.get(`/admin/products/info/standard/${infoId}`);
    return response.data;
  } catch (error: unknown) {
...
export const getEventInfoDetail = async (infoId: number): Promise<EventInfoDetailResponse> => {
  try {
    const response = await instance.get(`/admin/products/info/event/${infoId}`);
    return response.data;
  } catch (error: unknown) {
