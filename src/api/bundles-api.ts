...
export const getBundlesList = async (): Promise<BundleListResponse[]> => {
    try {
        ...
        console.error('❌ [getBundlesList] Error details:', {
            ...
            response: error instanceof Error && 'response' in error ? (error as { response?: unknown }).response : undefined
        });
...
export const getBundleDetail = async (groupId: number): Promise<BundleResponse> => {
    try {
        const response = await instance.get<BundleResponse>(`/bundles/${groupId}`);
        return response.data;
    } catch (error: unknown) {
...
export const createBundle = async (bundleData: BundleCreateRequest): Promise<BundleCreateResponse> => {
    try {
        const response = await instance.post<BundleCreateResponse>('/bundles/', bundleData);
        return response.data;
    } catch (error: unknown) {
...
export const updateBundle = async (
    ...
    try {
        const response = await instance.put<BundleUpdateResponse>(`/bundles/${groupId}`, bundleData);
        return response.data;
    } catch (error: unknown) {
...
export const deleteBundle = async (groupId: number): Promise<BundleDeleteResponse> => {
    try {
        const response = await instance.delete<BundleDeleteResponse>(`/bundles/${groupId}`);
        return response.data;
    } catch (error: unknown) {
...
export const deactivateBundle = async (groupId: number): Promise<BundleActivateResponse> => {
    try {
        const response = await instance.put<BundleActivateResponse>(`/bundles/${groupId}/deactivate`);
        return response.data;
    } catch (error: unknown) {
...
export const activateBundle = async (groupId: number): Promise<BundleActivateResponse> => {
    try {
        const response = await instance.put<BundleActivateResponse>(`/bundles/${groupId}/activate`);
        return response.data;
    } catch (error: unknown) {
