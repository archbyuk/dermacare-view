...
export const getCustomsList = async (): Promise<CustomListResponse[]> => {
    try {
        const response = await instance.get('/api/admin-tables/customs/');        
...
export const getCustomDetail = async (group_id: number): Promise<CustomResponse> => {
    try {
        const response = await instance.get(`/api/admin-tables/customs/${group_id}`);
        return response.data;
    } catch (error: unknown) {
...
export const createCustom = async (customData: CustomCreateRequest): Promise<CustomResponse> => {
    try {
        const response = await instance.post('/api/admin-tables/customs/', customData);
        return response.data;
    } catch (error: unknown) {
...
export const updateCustom = async (group_id: number, customData: CustomUpdateRequest): Promise<CustomResponse> => {
    try {
        const response = await instance.put(`/api/admin-tables/customs/${group_id}`, customData);
        return response.data;
    } catch (error: unknown) {
...
export const deleteCustom = async (group_id: number): Promise<{ status: string; message: string }> => {
    try {
        const response = await instance.delete(`/api/admin-tables/customs/${group_id}`);
        return response.data;
    } catch (error: unknown) {
...
export const deactivateCustom = async (group_id: number): Promise<{ status: string; message: string }> => {
    try {
        const response = await instance.put(`/api/admin-tables/customs/${group_id}/deactivate`);
        return response.data;
    } catch (error: unknown) {
...
export const activateCustom = async (group_id: number): Promise<{ status: string; message: string }> => {
    try {
        const response = await instance.put(`/api/admin-tables/customs/${group_id}/activate`);
        return response.data;
    } catch (error: unknown) {
