...
import ProcedureTypeRenderers from './procedure-type-renderers';
import ProcedurePreview from './procedure-preview';
...
export default function ProcedureInfoSection({
    ...
    return (
        <div className="space-y-4">
            ...
            {/* 시술 설명 (읽기 모드일 때만) */}
            {!isEditing && getProcedureDescription(displayProduct.procedure_info) !== '설명 없음' && (
                <div>
