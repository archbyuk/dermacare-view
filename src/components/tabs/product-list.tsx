...
export function ProductList({ onModalStateChange }: ProductListTabProps) {
    ...
    // 모달 스토어 사용
    const { openProductDetail } = useModalStore();
    ...
    const openTreatmentDetail = (treatment: Product) => {
        openProductDetail(treatment.ID, treatment.Product_Type);
